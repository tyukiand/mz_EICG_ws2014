...
class Matrix4d {
    public:
        ...
        inline Matrix4d operator + (const Matrix4d &m) const {
            Matrix4d res(
              m.M[0][0] + M[0][0], m.M[0][1] + M[0][1], m.M[0][2] + M[0][2], m.M[0][3] + M[0][3], 
              m.M[1][0] + M[1][0], m.M[1][1] + M[1][1], m.M[1][2] + M[1][2], m.M[1][3] + M[1][3], 
              m.M[2][0] + M[2][0], m.M[2][1] + M[2][1], m.M[2][2] + M[2][2], m.M[2][3] + M[2][3], 
              m.M[3][0] + M[3][0], m.M[3][1] + M[3][1], m.M[3][2] + M[3][2], m.M[3][3] + M[3][3]
            );
            return res;
        }
    protected:
