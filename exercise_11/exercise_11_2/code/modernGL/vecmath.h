...
class Vector3d {
    public:
        ...
        //multipliziert die beiden Vektoren komponentenweise um die multiplikation
        //mit einer DiagonalMatrix effizienter zu gestalten
        inline Vector3d comp_mult(const Vector3d& a) const{
...
class Quat4d {
    ...
    public:
        ...
        //Skalarprodukt für quaternionen
        inline double operator % (const Quat4d& a) const {
...
inline std::ostream& operator << (std::ostream& out, const Quat4d& a) {
            out << "(" << a.q[0] << "," << a.q[1] << "," << a.q[2] << "," << a.q[3] << ")";
            return out;
}
